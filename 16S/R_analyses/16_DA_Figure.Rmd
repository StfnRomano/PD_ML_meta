...
# double check that the direction  of enrichment is the same
...
# This is due to the fact that there is one mOTU pos and one negative.

df.sign$dirDA<-rep("black", length = nrow(df.sign))
# now add the red for the divergent mOTUs. NOTE: in the final figure this difference in color has been removed manually.
