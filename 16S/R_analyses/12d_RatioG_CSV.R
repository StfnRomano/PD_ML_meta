...
#  LOG
##############
load(paste0(args, "/RData/16S_Sinlge_5perc_log_ratioG.RData"))
...
saveRDS(csv_log, paste0(args, "/RDS/CSV_5perc_Log_df_auc_ratioG.rds"))


## --------------------------------------------------------------------------------------
print("Save wsp")
save.image(paste0(args, "/RData/Cross_validation_5perc_LOG_ratioG.Rdata"))
