...
GBM
```{r}
df.cross<-readRDS("~/Documents/EMBL_ML_PD//metaG//R_analyses/Functions/KO///RDS/df.DA.GBM.rds")
df.pos.neg<-readRDS("~/Documents/EMBL_ML_PD/metaG//R_analyses/Functions/KO/RDS/Ridge_df.pos.neg.GBM.rds")
...
16S
```{r}
df.cross<-readRDS("~/Documents/EMBL_ML_PD/16S/R_analyses/RDS/df.DA.rds")
