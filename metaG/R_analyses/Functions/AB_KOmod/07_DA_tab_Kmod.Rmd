...
df.cross<-readRDS("/metaG//R_analyses/Functions/AB_KOmod/RDS/df.cross.KOmod.rds")
...
# add the ML coefficinets
df.pos.neg<-readRDS("/metaG//R_analyses/Functions/AB_KOmod/RDS//Ridge_df.pos.neg.rds")
...
write.table(df.sign, "/metaG/R_analyses/Functions/AB_KOmod/df.sign.KOmod.txt",
            quote = F,
            col.names = T,
            row.names = F,
            sep = "\t")
write.table(df.pos.neg, "/metaG/R_analyses/Functions/AB_KOmod/df.pos.neg.KOmod.txt",
            quote = F,
            col.names = T,
            row.names = F,
            sep = "\t")
...
write.table(x = supp.table, 
            file = "/metaG//R_analyses/Functions/AB_KOmod/RDS/DA.table.complete.txt",
            col.names = T, 
            row.names = F, 
            quote = F,
            sep = "\t")
