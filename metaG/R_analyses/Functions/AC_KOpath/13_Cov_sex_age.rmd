...
saveRDS(df.estimates, "metaG/R_analyses/Functions/AC_KOpath/RDS/Conf.KOpath_bedarf_SexAge.rds")
```
## KOmod
```{r}
...
saveRDS(df.estimates, "metaG/R_analyses/Functions/AC_KOpath/RDS/Conf.KOmod_bedarf_SexAge.rds")
```
...
saveRDS(df.estimates, "metaG/R_analyses/Functions/AC_KOpath/RDS/Conf.KO_bedarf_SexAge.rds")
```
## Taxa
```{r}
...
saveRDS(df.estimates, "metaG/R_analyses/Functions/AC_KOpath/RDS/Conf.Taxa_bedarf_SexAge.rds")
```
## GBM
```{r}
...
df.estimates<-lm.conf(microbiome.feats = log_kop_w,
                  metadata = meta.all,
                  select.desc = "descr") 
saveRDS(df.estimates, "metaG/R_analyses/Functions/AC_KOpath/RDS/Conf.GBM_bedarf_SexAge.rds")
```
## GMM
```{r}
...
df.estimates<-lm.conf(microbiome.feats = log_kop_w,
                  metadata = meta.all,
                  select.desc = "descr") 
saveRDS(df.estimates, "metaG/R_analyses/Functions/AC_KOpath/RDS/Conf.GMM_bedarf_SexAge.rds")
```
