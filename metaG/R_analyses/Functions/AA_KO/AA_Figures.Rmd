...
```{r}
#cv
perf_sing_log<-readRDS("/metaG/R_analyses/Functions/AA_KO//RDS/Single_5per_log.w2500.2x5rds")
...
load("/metaG/R_analyses/Functions/AA_KO/RData/metaG_Sinlge_5perc_log_Wallen.w2500.2x5.RData")
df<-data.frame(
